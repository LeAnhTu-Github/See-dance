...
export const SHOT_SIZE_PRESETS = [
  ...
  { id: 'mls', label: 'Trung cảnh xa', labelEn: 'Medium Long Shot', abbr: 'MLS', promptToken: 'medium long shot, knee shot' },
  ...
  { id: 'pov', label: 'Cảnh chủ quan', labelEn: 'POV Shot', abbr: 'POV', promptToken: 'point of view shot, first person perspective' },
] as const;
...
export const SOUND_EFFECT_PRESETS = {
  ...
  urban: [
    ...
    { id: 'siren', label: 'Tiếng còi hú', promptToken: 'siren wailing' },
...
export const LIGHTING_STYLE_PRESETS = [
  { id: 'high-key' as const, label: 'Sáng tông cao', labelEn: 'High-Key', emoji: '☀️', promptToken: 'high-key lighting, bright and even,' },
  { id: 'low-key' as const, label: 'Tối tông thấp', labelEn: 'Low-Key', emoji: '🌑', promptToken: 'low-key lighting, dramatic shadows, film noir,' },
  ...
  { id: 'chiaroscuro' as const, label: 'Tương phản sáng tối', labelEn: 'Chiaroscuro', emoji: '🎨', promptToken: 'chiaroscuro lighting, Rembrandt style, strong contrast,' },
...
export const LIGHTING_DIRECTION_PRESETS = [
  ...
  { id: 'top' as const, label: 'Ánh sáng đỉnh', labelEn: 'Top', emoji: '🔽', promptToken: 'overhead top lighting,' },
  ...
  { id: 'three-point' as const, label: 'Bố trí ba điểm sáng', labelEn: 'Three-Point', emoji: '🔺', promptToken: 'three-point lighting setup,' },
] as const;

// 色温预设
export const COLOR_TEMPERATURE_PRESETS = [
  { id: 'warm' as const, label: 'Tông ấm 3200K', labelEn: 'Warm', emoji: '🟠', promptToken: 'warm color temperature 3200K,' },
  { id: 'neutral' as const, label: 'Trung tính 5500K', labelEn: 'Neutral', emoji: '⚪', promptToken: 'neutral daylight 5500K,' },
  { id: 'cool' as const, label: 'Tông lạnh 7000K', labelEn: 'Cool', emoji: '🔵', promptToken: 'cool blue color temperature,' },
...
export const DEPTH_OF_FIELD_PRESETS = [
  ...
  { id: 'shallow' as const, label: 'Trường ảnh nông f/2.8', labelEn: 'Shallow', emoji: '👤', promptToken: 'shallow depth of field, soft background bokeh,' },
  { id: 'medium' as const, label: 'Trung bình f/5.6', labelEn: 'Medium', emoji: '👥', promptToken: 'medium depth of field,' },
  { id: 'deep' as const, label: 'Trường ảnh sâu f/11', labelEn: 'Deep', emoji: '🏔️', promptToken: 'deep focus, everything sharp,' },
  { id: 'split-diopter' as const, label: 'Kính chia tiêu cự', labelEn: 'Split Diopter', emoji: '🪞', promptToken: 'split diopter lens, foreground and background both in focus,' },
] as const;

// 转焦预设
export const FOCUS_TRANSITION_PRESETS = [
  { id: 'none' as const, label: 'Tiêu điểm cố định', labelEn: 'None', promptToken: '' },
  { id: 'rack-to-fg' as const, label: 'Chuyển nét sang tiền cảnh', labelEn: 'Rack to FG', promptToken: 'rack focus to foreground,' },
  { id: 'rack-to-bg' as const, label: 'Chuyển nét sang hậu cảnh', labelEn: 'Rack to BG', promptToken: 'rack focus to background,' },
  { id: 'rack-between' as const, label: 'Chuyển nét giữa các nhân vật', labelEn: 'Rack Between', promptToken: 'rack focus between characters,' },
  { id: 'pull-focus' as const, label: 'Bám nét', labelEn: 'Pull Focus', promptToken: 'pull focus following subject movement,' },
] as const;
...
export const CAMERA_RIG_PRESETS = [
  ...
  { id: 'dolly' as const, label: 'Ray trượt dolly', labelEn: 'Dolly', emoji: '🛤️', promptToken: 'dolly tracking shot, smooth rail movement,' },
  { id: 'crane' as const, label: 'Cần cẩu', labelEn: 'Crane', emoji: '🏗️', promptToken: 'crane shot, sweeping vertical movement,' },
  { id: 'drone' as const, label: 'Quay flycam', labelEn: 'Drone', emoji: '🚁', promptToken: 'aerial drone shot, bird\'s eye perspective,' },
...
export const ATMOSPHERIC_EFFECT_PRESETS = {
  weather: [
    ...
    { id: 'mist' as const, label: 'Sương mỏng', emoji: '🌁', promptToken: 'light mist' },
  ],
  environment: [
  ...
  artistic: [
    ...
    { id: 'light-rays' as const, label: 'Hiệu ứng tia sáng Tyndall', emoji: '🌅', promptToken: 'god rays, light rays through atmosphere' },
    ...
    { id: 'particles' as const, label: 'Hạt bay', emoji: '💫', promptToken: 'floating particles' },
  ],
} as const;
...
export const PLAYBACK_SPEED_PRESETS = [
  ...
  { id: 'slow-motion-2x' as const, label: 'Quay chậm 0.5x', labelEn: 'Slow Mo', emoji: '🐢', promptToken: 'slow motion, 60fps,' },
  ...
  { id: 'timelapse' as const, label: 'Tua thời gian', labelEn: 'Timelapse', emoji: '⏱️', promptToken: 'timelapse, time passing rapidly,' },
] as const;
...
export const CAMERA_MOVEMENT_PRESETS = [
  ...
  { id: 'static' as const, label: 'Máy cố định', labelEn: 'Static', promptToken: 'static camera, locked off,' },
  ...
  { id: 'zoom-in' as const, label: 'Zoom cận', labelEn: 'Zoom In', promptToken: 'zoom in, lens zooming closer,' },
  { id: 'zoom-out' as const, label: 'Zoom xa', labelEn: 'Zoom Out', promptToken: 'zoom out, lens zooming wider,' },
  ...
  { id: 'dolly-in' as const, label: 'Tiến tới', labelEn: 'Dolly In', promptToken: 'dolly in, camera pushing forward,' },
  ...
  { id: 'drone-aerial' as const, label: 'Quay flycam', labelEn: 'Drone Aerial', promptToken: 'drone aerial shot, sweeping aerial movement,' },
  { id: '360-roll' as const, label: 'Xoay ngang 360°', labelEn: '360° Roll', promptToken: '360 degree barrel roll, rotating camera,' },
] as const;
...
export const SPECIAL_TECHNIQUE_PRESETS = [
  ...
  { id: 'timelapse' as const, label: 'Tua thời gian', labelEn: 'Timelapse', promptToken: 'timelapse, time passing rapidly,' },
  { id: 'crash-zoom-in' as const, label: 'Đẩy cận nhanh', labelEn: 'Crash Zoom In', promptToken: 'crash zoom in, sudden rapid zoom,' },
  { id: 'crash-zoom-out' as const, label: 'Kéo xa nhanh', labelEn: 'Crash Zoom Out', promptToken: 'crash zoom out, sudden rapid pull back,' },
  ...
  { id: 'fpv-shuttle' as const, label: 'FPV xuyên cảnh', labelEn: 'FPV Shuttle', promptToken: 'FPV drone shuttle, first person flight through scene,' },
  { id: 'macro-closeup' as const, label: 'Đặc tả macro', labelEn: 'Macro Close-up', promptToken: 'macro extreme close-up, intricate detail shot,' },
  ...
  { id: 'slow-motion' as const, label: 'Quay chậm', labelEn: 'Slow Motion', promptToken: 'slow motion, dramatic slow mo, high frame rate,' },
  { id: 'probe-lens' as const, label: 'Ống kính probe', labelEn: 'Probe Lens', promptToken: 'probe lens shot, snorkel camera, macro perspective movement,' },
...
export const EMOTION_PRESETS = {
  ...
  tone: [
    ...
    { id: 'relaxed', label: 'Thư giãn', emoji: '😌' },
    { id: 'playful', label: 'Trêu đùa', emoji: '😜' },
    { id: 'gentle', label: 'Dịu dàng', emoji: '😇' },
    { id: 'passionate', label: 'Hào hùng', emoji: '🔥' },
...
export const CAMERA_ANGLE_PRESETS = [
  ...
  { id: 'high-angle' as const, label: 'Góc cao', labelEn: 'High Angle', emoji: '⬇️', promptToken: 'high angle shot, looking down,' },
  { id: 'low-angle' as const, label: 'Góc thấp', labelEn: 'Low Angle', emoji: '⬆️', promptToken: 'low angle shot, looking up, heroic perspective,' },
  { id: 'birds-eye' as const, label: 'Nhìn từ trên cao', labelEn: "Bird's Eye", emoji: '🦅', promptToken: "bird's eye view, top-down overhead shot," },
  { id: 'worms-eye' as const, label: 'Nhìn từ dưới đất', labelEn: "Worm's Eye", emoji: '🐛', promptToken: "worm's eye view, extreme low angle from ground," },
  { id: 'over-shoulder' as const, label: 'Qua vai', labelEn: 'Over the Shoulder', emoji: '🫂', promptToken: 'over the shoulder shot, OTS,' },
  { id: 'side-angle' as const, label: 'Góc nghiêng', labelEn: 'Side Angle', emoji: '↔️', promptToken: 'side angle, profile view,' },
  { id: 'dutch-angle' as const, label: 'Góc nghiêng Hà Lan', labelEn: 'Dutch Angle', emoji: '📐', promptToken: 'dutch angle, tilted frame, canted angle,' },
...
export const FOCAL_LENGTH_PRESETS = [
  ...
  { id: '35mm' as const, label: '35mm Rộng tiêu chuẩn', labelEn: '35mm Standard Wide', emoji: '📷', promptToken: '35mm lens, natural wide perspective, street photography feel,' },
  ...
  { id: '105mm' as const, label: '105mm Tele trung', labelEn: '105mm Medium Tele', emoji: '🔭', promptToken: '105mm medium telephoto, gentle background compression,' },
  { id: '135mm' as const, label: '135mm Tele', labelEn: '135mm Telephoto', emoji: '📡', promptToken: '135mm telephoto lens, strong background compression, subject isolation,' },
...
export const PHOTOGRAPHY_TECHNIQUE_PRESETS = [
  { id: 'long-exposure' as const, label: 'Phơi sáng lâu', labelEn: 'Long Exposure', emoji: '🌊', promptToken: 'long exposure, motion blur, light trails, smooth water,' },
  ...
  { id: 'tilt-shift' as const, label: 'Chụp tilt-shift', labelEn: 'Tilt-Shift', emoji: '🏘️', promptToken: 'tilt-shift photography, miniature effect, selective focus plane,' },
  ...
  { id: 'bokeh' as const, label: 'Xóa phông trường ảnh nông', labelEn: 'Bokeh', emoji: '💫', promptToken: 'beautiful bokeh, creamy out-of-focus highlights, dreamy background blur,' },
  { id: 'reflection' as const, label: 'Chụp phản chiếu/gương', labelEn: 'Reflection', emoji: '🪞', promptToken: 'reflection photography, mirror surface, symmetrical composition,' },
  { id: 'silhouette-technique' as const, label: 'Chụp bóng đổ', labelEn: 'Silhouette', emoji: '🌅', promptToken: 'silhouette photography, dark figure against bright background, rim light outline,' },
] as const;
