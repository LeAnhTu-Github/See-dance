...
const FEATURE_CONFIGS: FeatureMeta[] = [
  {
    ...
    description: "Chia văn bản câu chuyện thành kịch bản có cấu trúc",
  ...
  },
  {
    ...
    recommendation: "💎 Khuyên dùng Nano Banana Pro (Gemini 3 Pro) — chất lượng ảnh đẹp, tính nhất quán cao",
  },
  {
    key: "video_generation",
    name: "Tạo video",
    description: "Chuyển ảnh thành video",
    icon: <Video className="h-4 w-4" />,
    requiredCapability: "video_generation",
    recommendation: "🧪 Khuyên dùng để test: doubao-seedance-1-0-lite-t2v-250428 — phù hợp để kiểm thử nhanh quy trình",
  },
  {
  ...
  },
  {
    key: "freedom_image",
    name: "Freedom - Ảnh",
    description: "Cấu hình tạo ảnh riêng cho mô-đun Freedom (nếu chưa cấu hình sẽ dùng \"Tạo ảnh\")",
    icon: <Sparkles className="h-4 w-4" />,
    requiredCapability: "image_generation",
    recommendation: "🎨 Có thể cấu hình model tạo ảnh riêng cho mô-đun Freedom mà không ảnh hưởng các mô-đun khác",
  },
  {
    key: "freedom_video",
    name: "Freedom - Video",
    description: "Cấu hình tạo video riêng cho mô-đun Freedom (nếu chưa cấu hình sẽ dùng \"Tạo video\")",
    icon: <Clapperboard className="h-4 w-4" />,
    requiredCapability: "video_generation",
    recommendation: "🎬 Có thể cấu hình model tạo video riêng cho mô-đun Freedom mà không ảnh hưởng các mô-đun khác",
  },
];
  ...
  return (
    <div className="p-6 border border-border rounded-xl bg-card space-y-6">
                ...
                <div className="px-4 pb-4 pt-0 border-t border-border/50">
                  {options.length === 0 ? (
                    <p className="text-xs text-muted-foreground py-2">
                      Chưa có model khả dụng (vui lòng cấu hình danh sách model trong mục Nhà cung cấp API trước)
                    </p>
                  ) : (
                    <div className="space-y-3 pt-3">
                      <p className="text-xs text-muted-foreground">
                        Có thể chọn nhiều, các yêu cầu sẽ được phân phối luân phiên tới các model (cách nhau 3 giây)
                      </p>
                        ...
                        return (
                          <div className="flex flex-col gap-1.5 px-3 py-2.5 rounded-md bg-blue-500/10 border border-blue-500/30">
                            ...
                            <span className="text-[11px] text-blue-600/80 dark:text-blue-400/80">
                              Nên thêm Key cho các nhóm trên trong dashboard memefast.top, càng nhiều Key thì tính khả dụng càng cao.
                            </span>
                          </div>
                        );
                      })()}
                      {isFreedomFeature && invalidBindings.length > 0 && (
                        <p className="text-[11px] text-amber-700 dark:text-amber-300">
                          Phát hiện liên kết tạm không khả dụng: hệ thống sẽ không tự xoá, khi model khả dụng trở lại sẽ tự động dùng tiếp.
                        </p>
                      )}
                      ...
                      {isFreedomFeature && (
                        <div className="flex items-center justify-between rounded-md border border-border/60 bg-muted/30 px-3 py-2">
                          <label className="flex items-center gap-2 text-xs font-medium text-foreground">
                            ...
                            />
                            Chọn tất cả model (bỏ chọn = không chọn gì cả)
                          </label>
        ...
        <div className="flex items-start gap-3 p-3 bg-destructive/10 border border-destructive/30 rounded-lg">
          ...
          <div className="text-xs">
            ...
            <p className="text-muted-foreground mt-1">
              Vui lòng chọn "Nhà cung cấp / Model" cho từng tính năng ở trên, và đảm bảo đã điền API Key cho nhà cung cấp tương ứng.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="text-xs text-muted-foreground bg-muted/50 p-3 rounded-lg space-y-2">
        <p>
          <strong>💡 Luân phiên nhiều model:</strong>
          Mỗi tính năng có thể chọn nhiều model, các yêu cầu sẽ được phân phối lần lượt tới từng model (cách nhau 3 giây), tránh bị giới hạn tần suất khi dùng một API duy nhất.
        </p>
        <p>
          <strong>📌 Lưu ý:</strong>
          Các lựa chọn đến từ danh sách model trong mục "Nhà cung cấp API", nhấp để mở rộng rồi chọn nhiều.
        </p>
      </div>
    </div>
  );
