      ...
      <Tabs value={mode} onValueChange={(v) => setMode(v as "import" | "create")}>
          ...
          <div className="space-y-2">
            ...
            {importStatus === "ready" && (
              <div className="space-y-1">
                <p className="text-xs text-green-600">✓ Import thành công! Bấm tên tập ở bên phải để tạo phân cảnh</p>
            ...
            {importStatus === "error" && importError && (
              <p className="text-xs text-destructive">Import thất bại: {importError}</p>
            )}
                  ...
                  {secondPassTypes && secondPassTypes.size > 0 ? (
                    ...
                    <>
                      ...
                      <div className={`flex items-center gap-3 py-1 ${importStatus === 'importing' ? 'text-primary font-bold' : importStatus === 'ready' ? 'text-green-600 font-medium' : 'text-muted-foreground'}`}>
                        ...
                        <span className="text-base">Import kịch bản</span>
                      </div>
        ...
        <TabsContent value="create" className="flex-1 mt-3">
          <div className="space-y-3">
            <div className="space-y-2">
              <Label className="text-xs text-muted-foreground">
                Nhập ý tưởng câu chuyện, AI sẽ tạo kịch bản cho bạn
              </Label>
              <Textarea
                placeholder="Ví dụ: Câu chuyện ấm áp về một lập trình viên hướng nội gặp gỡ cô gái vui tươi tại quán cà phê..."
                value={idea}
              ...
              <div className="p-3 rounded-lg bg-primary/5 border border-primary/20 space-y-2">
                ...
                <div className="space-y-1.5 text-xs text-muted-foreground">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Chọn bối cảnh ở cột giữa → cột phải bấm "Đến thư viện bối cảnh để tạo background"</span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span>Chọn nhân vật → cột phải bấm "Đến thư viện nhân vật để tạo hình"</span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span>Chọn phân cảnh → cột phải bấm "Đến AI đạo diễn để tạo video"</span>
                  </div>
                </div>
              </div>
            )}
      ...
      <div className="space-y-3 pt-2 border-t">
        ...
        {mode === "import" && (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1">
                <Label className="text-xs">Số lượng cảnh (tuỳ chọn)</Label>
                <Select
                  value={sceneCount || ""}
              ...
              <div className="space-y-1">
                <Label className="text-xs">Số lượng phân cảnh (tuỳ chọn)</Label>
                {showCustomShotInput ? (
            ...
            <div className="space-y-1">
              ...
              />
              <p className="text-[10px] text-muted-foreground">
                Phong cách này sẽ được dùng khi AI hiệu chỉnh phân cảnh để tạo mô tả hình ảnh
              </p>
            </div>
          </div>
        )}
        ...
        {mode === "create" && (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-1">
                <Label className="text-xs">Số lượng bối cảnh (tuỳ chọn)</Label>
                <Select
                  value={sceneCount || ""}
                  onValueChange={(v) => onSceneCountChange?.(v)}
                  disabled={parseStatus === "parsing"}
            ...
            >
              {isCalibrating || calibrationStatus === 'calibrating' ? (
                ...
                <>
                  ...
                  AI hiệu chỉnh (tạo tiêu đề cho {missingTitleCount} tập)
                </>
              )}
            </Button>
          )}
              ...
              {isGeneratingSynopsis || synopsisStatus === 'generating' ? (
                ...
                <>
                  ...
                  {(missingSynopsisCount ?? 0) > 0
                    ? `Tạo đại cương (thiếu ${missingSynopsisCount} tập)`
                    : 'Tạo lại đại cương'
                  }
                </>
              )}
