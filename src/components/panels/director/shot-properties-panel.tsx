...
export function ShotPropertiesPanel({
  ...
  const handleApplyAngleSwitch = () => {
    ...
    setPreviewItem({
      ...
      name: `Shot ${shotIndex + 1} - ${angleSwitchTarget === "start" ? "Khung đầu" : "Khung cuối"} (chuyển góc)`,
    });
  ...
  const handleGenerateImage = async (type: "start" | "end") => {
    ...
    try {
      ...
      setPreviewItem({
        type: "image",
        url: imageUrl,
        name: `Shot ${shotIndex + 1} - ${type === "start" ? "Khung đầu" : "Khung cuối"}`,
      });
    ...
    return (
      <div className="h-full flex flex-col bg-panel">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground p-4">
          ...
          <p className="text-sm text-center">Chọn một shot</p>
          <p className="text-xs text-center mt-1 opacity-60">Xem và chỉnh sửa thuộc tính shot</p>
        </div>
      </div>
    );
  }
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <div className="p-1.5 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px]">Khung đầu</span>
                    <Button
                      size="sm"
                      variant="ghost"
              ...
              >
                <div className="aspect-video bg-muted relative">
                  {hasEndImage ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-[9px] text-muted-foreground/50">Tuỳ chọn</span>
                    </div>
                  )}
                  {processingType === "end" && (
                    <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                ...
                <div className="p-1.5 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px]">Khung cuối</span>
                    <Button
                      size="sm"
                      variant="ghost"
                      className="h-5 px-1.5 text-[10px]"
              ...
              <div className="p-2">
                ...
                {!hasStartImage && (
                  <p className="text-[9px] text-muted-foreground text-center mt-1">
                    Vui lòng tạo khung đầu trước
                  </p>
                )}
                {hasStartImage && !hasEndImage && (
                  <p className="text-[9px] text-muted-foreground text-center mt-1">
                    Sẽ dùng chế độ đơn ảnh (Image-to-Video)
                  </p>
                )}
              </div>
            </div>
