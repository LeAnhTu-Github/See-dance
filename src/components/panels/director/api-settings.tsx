...
export function APISettings({ collapsed = true, onToggleCollapse }: APISettingsProps) {
  ...
  const providers: Array<{
  ...
  }> = [
    {
      id: "memefast",
      name: "Moyin API",
      description: "AI trung chuyển toàn diện, hỗ trợ chat/ảnh/video/hiểu ảnh",
      services: ["Chat", "Ảnh", "Video", "Hiểu ảnh"],
    },
    {
      id: "runninghub",
      name: "RunningHub",
      description: "Qwen chuyển góc nhìn / tạo nhiều góc",
      services: ["Chuyển góc", "Ảnh sang ảnh"],
    },
  ];
    ...
    <div className="border rounded-lg p-4 space-y-4">
      ...
      <div className="pt-2 border-t space-y-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-muted-foreground">
            Số cảnh tạo đồng thời (nếu dùng 1 Key nên đặt là 1)
          </span>
        </div>
      </div>
      ...
      <div className="pt-2 border-t">
        <p className="text-xs text-muted-foreground">
          💡 API Key chỉ được lưu trong trình duyệt cục bộ, không tải lên máy chủ
        </p>
      </div>
    </div>
  );
