                ...
                <div key={char.id} className="space-y-0.5">
                  ...
                  {isSelected && availableVariations.length > 0 && onChangeVariation && (
                    <div className="ml-8 mr-1 mb-1 space-y-0.5">
                      ...
                      >
                        {thumbnail ? (
                          <img src={thumbnail} alt="Ảnh cơ sở" className="w-8 h-8 rounded object-cover shrink-0 border border-muted-foreground/10" />
                        ) : (
                          <div className="w-8 h-8 rounded bg-muted flex items-center justify-center shrink-0">
                            <User className="h-3 w-3" />
                          </div>
                        )}
                        <span className="flex-1 text-[11px] truncate">Ảnh cơ sở</span>
