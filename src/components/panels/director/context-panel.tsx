...
export function DirectorContextPanel() {
  ...
  const handleAddSceneToSplitScenes = (scene: ScriptScene) => {
    ...
    const matchInfo = matchedCount > 0 ? ` (${matchedCount} đã khớp thư viện cảnh)` : '';
      ...
      <div className="h-full min-w-0 flex flex-col overflow-x-hidden">
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="text-center text-muted-foreground text-sm">
            ...
            <p className="mt-1">Vui lòng phân tích kịch bản ở panel Kịch bản trước</p>
          </div>
        </div>
                                ...
                                return (
                                  <div key={shot.id} className="flex items-center group">
                                    <button
                                      ...
                                      title="Nhấp: gửi đến AI Đạo diễn | Nhấp đúp: thêm trực tiếp vào chỉnh sửa"
                                    >
