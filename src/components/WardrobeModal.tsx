      ...
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col bg-zinc-900 border-zinc-800">
        <DialogHeader className="shrink-0">
          <DialogTitle className="flex items-center gap-3 text-white">
            ...
            {character.name} - Quản lý tạo hình
          </DialogTitle>
          <DialogDescription className="text-zinc-500">
            Tạo các biến thể trang phục, trạng thái hoặc tạo hình khác nhau cho nhân vật, dùng cho việc tạo shot ở các bối cảnh khác nhau.
          </DialogDescription>
        </DialogHeader>
              ...
              {showAddForm && (
                <div className="p-4 bg-zinc-800/50 rounded-lg border border-zinc-700 space-y-3">
                  <div className="space-y-2">
                    ...
                    <Input
                      placeholder="Ví dụ: Trang phục thường ngày, trang phục chiến đấu, dạ tiệc..."
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs text-zinc-400">Mô tả hình ảnh (tiếng Anh)</Label>
                    <Textarea
              ...
              {variations.length === 0 && !showAddForm && (
                <div className="py-8 text-center">
                  ...
                  <p className="text-xs text-zinc-600 mt-1">
                    Thêm biến thể với trang phục hoặc trạng thái khác nhau
                  </p>
                </div>
              )}
            </div>
