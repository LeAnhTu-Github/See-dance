      ...
      <DialogContent className="max-w-2xl p-4 bg-zinc-900 border-zinc-800">
        <DialogHeader className="pb-2">
          <DialogTitle className="text-sm text-white flex items-center gap-2">
            ...
            Kết quả lưới 4 ô - {frameType === "start" ? "Frame đầu" : "Frame cuối"}
          </DialogTitle>
          <DialogDescription className="text-xs text-zinc-400">
            Nhấp để chọn ảnh, có thể áp dụng cho phân cảnh hiện tại hoặc sao chép sang phân cảnh khác
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            {/* 原图 */}
            <div className="w-1/4">
              <div className="text-[10px] text-zinc-500 mb-1">Ảnh neo gốc</div>
          ...
          {otherScenes.length > 0 && (
            <div className="flex items-center gap-2 p-3 rounded bg-zinc-800/50 border border-zinc-700">
              ...
              <Select value={copyTargetFrame} onValueChange={(v) => setCopyTargetFrame(v as "start" | "end")}>
                ...
                <SelectContent>
                  <SelectItem value="start" className="text-xs">Frame đầu</SelectItem>
                  <SelectItem value="end" className="text-xs">Frame cuối</SelectItem>
                </SelectContent>
              </Select>
              <Button
                size="sm"
        ...
        <DialogFooter className="gap-2 pt-2">
          ...
          >
            ...
            Áp dụng cho {frameType === "start" ? "Frame đầu" : "Frame cuối"}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
