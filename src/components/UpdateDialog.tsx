  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="max-w-xl">
        <AlertDialogHeader>
          <AlertDialogTitle>Đã có phiên bản mới v{updateInfo.latestVersion}</AlertDialogTitle>
          <AlertDialogDescription>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border border-border bg-card p-4 space-y-3">
            <div className="flex items-center justify-between gap-3">
              <div>
                <p className="text-sm font-medium text-foreground">Phương thức tải</p>
                <p className="text-xs text-muted-foreground mt-1">
                  Bạn có thể tải bản cài đặt mới nhất từ GitHub hoặc Baidu Netdisk.
                </p>
              </div>
            ...
            {(!updateInfo.githubUrl && !updateInfo.baiduUrl) && (
              <p className="text-xs text-destructive">Bản phát hành này chưa cung cấp liên kết tải về.</p>
            )}
